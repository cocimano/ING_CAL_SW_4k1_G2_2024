            ...
            <div className="mt-5">
                {loading && (
                    <div className="flex items-center justify-center">
                        <div className="mt-20 h-[230px]" role="status">
                            <div className="text-center mt-4 text-gray-700 font-extrabold flex">
                                Cargando pedidos entregados... {" "}
                                <svg aria-hidden="true" className="w-5 h-5 text-gray-200 animate-spin dark:text-gray-600 fill-[#F7BE38]" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                {!loading && (
                    <OrderCard orders={deliveredOrders} />
                )}
            </div>
        </>
    )
